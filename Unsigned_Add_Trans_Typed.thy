...
theory Unsigned_Add_Trans_Typed
...
lemma well_typed:
  ...
  by (metis atype bexp_wt.intros(15) bexp_wt.intros(3) btype ctype len1 len2 len_def seq_wt.intros(4))
...
proof - 
  have bexpA: "bexp_wt \<Gamma> (Bsig A) (Lty Uns len1)" and bexpB: "bexp_wt \<Gamma> (Bsig B) (Lty Uns len2)"
    using unsigned_addition_axioms unfolding unsigned_addition_def by (metis bexp_wt.intros(3))+
...
lemma correctness:
  ...
  unfolding  inv_def by (metis (no_types, lifting) add_diff_cancel_right' assms(1)
